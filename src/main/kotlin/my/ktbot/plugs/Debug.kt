...
object Debug {
	...
	@OptIn(MiraiExperimentalApi::class)
	@MiraiEventHandle("test2")
	@RegexAnn("^[.．。]test2$", RegexOption.IGNORE_CASE)
	@NeedAdmin
	@SendAuto
	...
	@OptIn(MiraiExperimentalApi::class)
	@MiraiEventHandle("test3")
	@RegexAnn("^[.．。]test3$", RegexOption.IGNORE_CASE)
	@NeedAdmin
	@SendAuto
	private fun MessageEvent.test3(): Message {
		val image = message.firstIsInstanceOrNull<Image>() ?: return PlainText("图片")
		val md5 = image.imageId.imageIdToMd5()
		val serviceID = 5
		val actionData = "mqqapi://card/show_pslcard?src_type=internal&amp;source=sharecard&amp;version=1&amp;uin=2938137849"
